...
import sdo.core.domain.{Entity, Field, BooleanField, Predicate, AndPredicate, OrPredicate, NotPredicate }
...
class PredicateSpecs extends Specification {
	...
	class PredicateEntity extends Entity {
	...
	val trueEntity = new PredicateEntity 
	val falseEntity = new PredicateEntity 
